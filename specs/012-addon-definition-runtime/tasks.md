...
- [ ] T064 Close the runtime-policy validation bypass: resolve and fresh-fence the policy, run shared validation before execution, return `Accepted=False/InvalidPolicy`, preserve prior evidence, recover after a valid policy, and record component plus live coverage in execution.md. Keep this task open until the correction and its verification pass.
