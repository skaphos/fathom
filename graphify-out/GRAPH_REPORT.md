# Graph Report - rebase-pr-121  (2026-07-06)

## Corpus Check
- 149 files · ~155,946 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2289 nodes · 3695 edges · 173 communities (154 shown, 19 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 543 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `44f7268c`
...
4. `writeFile()` - 25 edges
5. `NewScheme()` - 21 edges
6. `deploymentInNamespace()` - 21 edges
7. `newFakeClient()` - 20 edges
8. `healthyObjects()` - 20 edges
9. `newFakeClient()` - 19 edges
10. `Family` - 18 edges
...
Cohesion: 0.13
Nodes (41): assertFamily(), assertHasDetail(), assertHasOutcome(), assertNoKind(), certManagerResource(), establishedCRD(), establishedCRDServing(), healthyDeployment() (+33 more)
...
Cohesion: 0.09
Nodes (29): Absence semantics, Authoring an Adapter, code:go (declarative.AddonDefinition{), code:console ($ go -C tools tool task gen:addon-rbac), code:markdown (### New adapter checklist (SKA-68)), code:go (declarative.FamilyDefinition{), code:go (declarative.CRDCheck{), code:go (declarative.ConditionCheck{) (+21 more)

### Community 14 - "Community 14"
Cohesion: 0.2
Nodes (26): NewCiliumEngine(), clientObject, assertFamily(), assertHasDetail(), assertHasOutcome(), assertNoKind(), assertNoOutcome(), ciliumCRD() (+18 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (28): [0.0.2](https://github.com/skaphos/fathom/compare/v0.0.1...v0.0.2) (2026-05-17), Bug Fixes, Changelog, Features, [0.0.2](https://github.com/skaphos/fathom/compare/v0.0.1...v0.0.2) (2026-05-17), Bug Fixes, Changelog, Features (+20 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (27): Adapter catalog, Add-on Checks, cert-manager, Cilium, code:yaml (apiVersion: fathom.skaphos.io/v1alpha1), code:block10 (per-AddonCheck probeImage threshold  >  operator --probe-ima), code:yaml (apiVersion: fathom.skaphos.io/v1alpha1), code:yaml (spec:) (+19 more)
...
Cohesion: 0.18
Nodes (20): minimalKubeconfig, DefaultCertPaths(), isCertFile(), isKubeconfigFile(), MinimalMountDirs(), classify(), classifyAll(), daysFromDuration() (+12 more)
...
Cohesion: 0.1
Nodes (16): Adapter, IsAbsent(), MarkVersionGate(), TestFamilyOutcome(), TestMarkAbsentAndIsAbsent(), TestMarkVersionGate(), TestOutcomeValid(), Capabilities (+8 more)
...
Cohesion: 0.17
Nodes (15): appFakeAdapter, DefaultOptions(), TestValidate(), TestValidate_MultipleErrorsAccumulate(), BuildManagerOptions(), TestBuildAdapterRegistry_WrapsRegistrationErrors(), TestBuildManagerOptions_CertWatchers(), TestBuildManagerOptions_DefaultsHaveNoCertWatchers() (+7 more)

### Community 32 - "Community 32"
Cohesion: 0.19
Nodes (14): addonAdapterLookup, addonCheckDueForRun(), addonCheckInterval(), addonCheckPolicy(), addonCheckTargetRef(), addonCheckTimeout(), aggregateHealthReportResult(), copyStringMap() (+6 more)
...
Cohesion: 0.14
Nodes (10): crdAbsenceEngine(), TestCRD_AbsenceResolution(), Engine, endRunSpan(), MustEngine(), NewEngine(), TestNewEngine_Validation(), validWorkloadKind() (+2 more)

### Community 42 - "Community 42"
Cohesion: 0.25
Nodes (15): runManaged(), TestCondition_ClusterScopedListsWithoutNamespace(), TestCondition_ConditionStatus(), TestCondition_InvalidAPIVersionErrors(), TestCondition_InvalidSelectorErrors(), TestCondition_ListNameFallsBackToKind(), TestCondition_NamedClusterScopedGet(), TestCondition_NamedGetScoresFoundObject() (+7 more)
...
Cohesion: 0.29
Nodes (15): Scan(), makeCertPEM(), TestScanBundleEmitsPerCert(), TestScanDefaultsWhenNoPaths(), TestScanDirectoryRecursiveAndIgnoresNonCerts(), TestScanKubeconfig(), TestScanMissingPathIsSilent(), TestScanPermissionDeniedIsSkippedNotError() (+7 more)

### Community 49 - "Community 49"
Cohesion: 0.24
Nodes (14): deploymentInNamespace(), detectAddonVersion(), imageTag(), pickImage(), deploymentWithImage(), deploymentWithMetaVersion(), deploymentWithTemplateVersion(), TestDetectAddonVersion() (+6 more)
...
Cohesion: 0.16
Nodes (9): NewScheme(), TestNewScheme_RegistersAPIExtensions(), TestNewScheme_RegistersFathomTypes(), addonSA(), TestAdapterClient(), TestRunAddonCheckFailsClosedWithoutScopedClient(), fakeClientFactory, TestAddToScheme() (+1 more)
...
Cohesion: 0.22
Nodes (7): validateAddonCheckPolicy(), fakePolicyAdapter, badSelector(), checkWithPolicy(), TestSetAddonCheckAccepted(), TestValidateAddonCheckPolicy(), TestValidateAddonCheckPolicy_DeterministicOrder()
...
Cohesion: 0.3
Nodes (10): BuildAdapterRegistry(), BuiltInAdapters(), DefaultControllers(), operatorVersion(), readyzCheck(), Run(), TestBuildAdapterRegistry_RegistersBuiltInAdapters(), TestBuiltInAdapters_AllLookupable() (+2 more)
...
Cohesion: 0.18
Nodes (10): Addon adapter RBAC, cert-manager, cilium, coredns, envoy-gateway, external-dns, external-secrets, istio (+2 more)
...
Cohesion: 0.18
Nodes (11): AddonCheckReconciler, addonAdapterLookup interface, aggregateHealthReportResult, healthReportResult (outcome mapping), fakeAddonAdapter (test double), AddonCheck Controller envtest suite, adapterOutcome (probe.Outcome mapping), HealthReportResult.Severity() (+3 more)

### Community 96 - "Community 96"
Cohesion: 0.2
Nodes (7): AddonDefinition, CRDCheck, FamilyDefinition, Posture, RBACRule, VersionSource, WorkloadKind
...
Cohesion: 0.27
Nodes (4): summarizeFromConditions(), HealthCheckReconciler, endReconcileSpan(), reconcilerTracer()
...
Cohesion: 0.22
Nodes (10): AddonCheckReconciler.Reconcile, healthReportForAddonCheck, labels fathom.skaphos.io/source-{kind,name}, AddonCheckReconciler.pruneHealthReportHistory, resolveAddonAdapter, AddonCheckReconciler.runAddonCheck, HealthReport CRD type, HealthReportCheck (+2 more)

### Community 105 - "Community 105"
Cohesion: 0.2
Nodes (10): ClusterHealthReconciler.SetupWithManager, ClusterHealth CRD type, ClusterHealthSpec, TestAddToScheme, HealthCheckReconciler.Reconcile, HealthCheckReconciler.mirrorTarget, summarizeFromConditions, CheckTargetRef (+2 more)
...
Cohesion: 0.25
Nodes (8): AddonCheck CRD type, AddonCheckFamilyPolicy, AddonCheckSpec, HealthCheckReconciler, HealthCheckReconciler.SetupWithManager, healthChecksForAddonCheck (watch map), Rationale: HealthCheck as wrapper (ADR-0004), HealthCheck Controller envtest suite
...
Cohesion: 0.33
Nodes (6): AddonCheckStatus, ClusterHealthChildSummary, ClusterHealthStatus, TestDeepCopyRoundTrip, HealthCheckStatus, HealthReportResult enum
...
## Knowledge Gaps
- **711 isolated node(s):** `config`, `RBACDeclarer`, `version`, `Adapter`, `Capabilities` (+706 more)
...
- **Why does `join()` connect `Community 44` to `Community 1`, `Community 130`, `Community 131`, `Community 2`, `Community 6`, `Community 8`, `Community 139`, `Community 17`, `Community 18`, `Community 19`, `Community 24`, `Community 25`, `Community 31`, `Community 32`, `Community 35`, `Community 48`, `Community 56`, `Community 67`, `Community 91`, `Community 97`, `Community 107`, `Community 124`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `NewScheme()` connect `Community 51` to `Community 3`, `Community 5`, `Community 7`, `Community 73`, `Community 9`, `Community 109`, `Community 14`, `Community 113`, `Community 17`, `Community 31`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `FamilyOutcome()` connect `Community 1` to `Community 2`, `Community 41`, `Community 10`, `Community 9`, `Community 14`, `Community 18`, `Community 28`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Are the 51 inferred relationships involving `join()` (e.g. with `normalizeShell()` and `runMain()`) actually correct?**
