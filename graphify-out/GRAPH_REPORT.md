# Graph Report - ska-62-external-dns  (2026-07-05)

## Corpus Check
- 138 files · ~144,988 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2060 nodes · 3329 edges · 149 communities (128 shown, 21 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 478 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f473aca`
...
Cohesion: 0.06
Nodes (77): Family, NewCiliumEngine(), clientObject, crdAbsenceEngine(), TestCRD_AbsenceResolution(), endRunSpan(), MustEngine(), NewEngine() (+69 more)
...
Cohesion: 0.06
Nodes (35): Branching and Commits, Coding Standards, Contributing Guidelines, Development Setup, Pull Requests, Safety Expectations, Testing, Branching and Commits (+27 more)
...
Cohesion: 0.14
Nodes (23): certificateCheck(), certificateDetails(), check(), conditionDetails(), conditionStatus(), conditionType(), crdEstablished(), crdServesV1() (+15 more)
...
Cohesion: 0.1
Nodes (21): Adapter catalog, Add-on Checks, cert-manager, Cilium, code:yaml (apiVersion: fathom.skaphos.io/v1alpha1), code:yaml (spec:), code:yaml (spec:), code:yaml (spec:) (+13 more)

### Community 26 - "Community 26"
Cohesion: 0.1
Nodes (20): [0.0.2](https://github.com/skaphos/fathom/compare/v0.0.1...v0.0.2) (2026-05-17), Bug Fixes, Changelog, Features, [0.0.2](https://github.com/skaphos/fathom/compare/v0.0.1...v0.0.2) (2026-05-17), Bug Fixes, Changelog, Features (+12 more)
...
Cohesion: 0.18
Nodes (14): appFakeAdapter, DefaultOptions(), TestValidate(), TestValidate_MultipleErrorsAccumulate(), BuildManagerOptions(), TestBuildManagerOptions_CertWatchers(), TestBuildManagerOptions_DefaultsHaveNoCertWatchers(), TestBuildManagerOptions_InsecureMetricsHasNoFilter() (+6 more)
...
Cohesion: 0.12
Nodes (13): Adapter, MarkVersionGate(), TestFamilyOutcome(), TestMarkAbsentAndIsAbsent(), TestMarkVersionGate(), TestOutcomeValid(), Capabilities, CheckResult (+5 more)
...
Cohesion: 0.19
Nodes (12): FamilyOutcome(), certManagerComponents(), endAdapterRunSpan(), familyEnabled(), familyPolicy(), includesKind(), policyNamespaces(), restartWarnCount() (+4 more)
...
Cohesion: 0.15
Nodes (5): Adapter, deploymentAvailable(), mutatingWebhookClients(), validateWebhookClients(), validatingWebhookClients()
...
Cohesion: 0.27
Nodes (10): BuildAdapterRegistry(), BuiltInAdapters(), DefaultControllers(), operatorVersion(), readyzCheck(), Run(), TestBuildAdapterRegistry_RegistersBuiltInAdapters(), TestBuildAdapterRegistry_WrapsRegistrationErrors() (+2 more)
...
Cohesion: 0.17
Nodes (12): ClusterHealth CRD type, ClusterHealthSpec, ClusterHealthStatus, TestAddToScheme, HealthCheckReconciler.Reconcile, CheckTargetRef, HealthCheck CRD type, HealthCheckSpec (+4 more)
...
Cohesion: 0.28
Nodes (9): AddonCheckReconciler, addonAdapterLookup interface, aggregateHealthReportResult, healthReportForAddonCheck, labels fathom.skaphos.io/source-{kind,name}, AddonCheckReconciler.pruneHealthReportHistory, AddonCheckReconciler.runAddonCheck, fakeAddonAdapter (test double) (+1 more)
...
Cohesion: 0.25
Nodes (7): Addon adapter RBAC, cert-manager, cilium, coredns, external-dns, external-secrets, Operator impersonation grant
...
## Knowledge Gaps
- **604 isolated node(s):** `config`, `RBACDeclarer`, `version`, `Adapter`, `Capabilities` (+599 more)
...
- **Why does `join()` connect `Community 39` to `Community 2`, `Community 8`, `Community 9`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 32`, `Community 33`, `Community 50`, `Community 51`, `Community 66`, `Community 78`, `Community 81`, `Community 82`, `Community 87`, `Community 111`, `Community 112`, `Community 118`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `NewScheme()` connect `Community 43` to `Community 32`, `Community 65`, `Community 97`, `Community 1`, `Community 4`, `Community 6`, `Community 10`, `Community 11`, `Community 16`, `Community 86`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `FamilyOutcome()` connect `Community 46` to `Community 1`, `Community 2`, `Community 40`, `Community 11`, `Community 12`, `Community 18`, `Community 92`?**
