...
## Corpus Check
- 144 files · ~150,391 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2244 nodes · 3561 edges · 169 communities (148 shown, 21 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 502 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df3da0f4`
...
6. `newFakeClient()` - 20 edges
7. `healthyObjects()` - 20 edges
...
## Communities (169 total, 21 thin omitted)
...
Cohesion: 0.05
Nodes (32): Adapter, MarkAbsent(), MarkVersionGate(), TestFamilyOutcome(), TestMarkAbsentAndIsAbsent(), TestMarkVersionGate(), TestOutcomeValid(), Capabilities (+24 more)
...
Cohesion: 0.08
Nodes (34): agentLabels(), agentResourceName(), aggregateNodeReports(), healthReportForNodeCert(), joinPaths(), mergeLabels(), nodeCertInterval(), nodeCertTimeout() (+26 more)
...
Cohesion: 0.08
Nodes (27): Absence semantics, Authoring an Adapter, code:go (declarative.AddonDefinition{), code:markdown (### New adapter checklist (SKA-68)), code:go (declarative.FamilyDefinition{), code:go (declarative.CRDCheck{), code:go (declarative.ConditionCheck{), code:go (declarative.ConditionCheck{) (+19 more)
...
Cohesion: 0.1
Nodes (25): Adapter catalog, Add-on Checks, cert-manager, Cilium, code:yaml (apiVersion: fathom.skaphos.io/v1alpha1), code:yaml (apiVersion: fathom.skaphos.io/v1alpha1), code:yaml (spec:), code:yaml (spec:) (+17 more)
...
Cohesion: 0.12
Nodes (12): TestMustEngine_PanicsOnInvalid(), crdAbsenceEngine(), TestCRD_AbsenceResolution(), Engine, endRunSpan(), MustEngine(), NewEngine(), TestNewEngine_Validation() (+4 more)
...
Cohesion: 0.26
Nodes (18): podInNamespace(), absenceEngine(), deployEngine(), notReadyPod(), podWithRestarts(), runEngine(), statefulSet(), stsEngine() (+10 more)
...
Cohesion: 0.28
Nodes (14): runManaged(), TestCondition_ClusterScopedListsWithoutNamespace(), TestCondition_ConditionStatus(), TestCondition_InvalidAPIVersionErrors(), TestCondition_InvalidSelectorErrors(), TestCondition_ListNameFallsBackToKind(), TestCondition_NamedClusterScopedGet(), TestCondition_NamedGetScoresFoundObject() (+6 more)
...
Cohesion: 0.25
Nodes (10): addonAdapterLookup, addonCheckPolicy(), addonCheckTargetRef(), addonCheckTimeout(), aggregateHealthReportResult(), copyStringMap(), healthReportChecks(), healthReportForAddonCheck() (+2 more)
...
Cohesion: 0.4
Nodes (12): Scan(), makeCertPEM(), TestClassifyBoundaries(), TestScanBundleEmitsPerCert(), TestScanDefaultsWhenNoPaths(), TestScanDirectoryRecursiveAndIgnoresNonCerts(), TestScanKubeconfig(), TestScanMissingPathIsSilent() (+4 more)
...
Cohesion: 0.24
Nodes (7): addonCheckDueForRun(), addonCheckInterval(), resolveAddonAdapter(), setAddonCheckAccepted(), TestSetAddonCheckAccepted(), endReconcileSpan(), reconcilerTracer()
...
Cohesion: 0.2
Nodes (9): Addon adapter RBAC, cert-manager, cilium, coredns, envoy-gateway, external-dns, external-secrets, metrics-server (+1 more)
...
Cohesion: 0.2
Nodes (10): ClusterHealthReconciler.SetupWithManager, clusterHealthsForHealthCheck (watch map), selectorFromSpec, ClusterHealth Controller envtest suite, HealthCheckReconciler.Reconcile, HealthCheckReconciler.mirrorTarget, summarizeFromConditions, CheckTargetRef (+2 more)
...
Cohesion: 0.36
Nodes (6): version, EnsureCompatible(), parseVersion(), TestContractVersionParses(), TestEnsureCompatible(), TestParseVersion()
...
Cohesion: 0.25
Nodes (8): ClusterHealthReconciler.Reconcile, ClusterHealth CRD type, ClusterHealthSpec, TestAddToScheme, HealthReport CRD type, HealthReportCheck, HealthReportSpec, HealthReportTargetRef
...
Cohesion: 0.29
Nodes (7): ClusterHealthReconciler, ClusterHealthReconciler.aggregate, Invariant: ClusterHealth never reads HealthReport (ADR-0004), HealthReportResult.Severity(), TestHealthReportResultSeverity_EmptyAndUnrecognizedReturnZero, TestHealthReportResultSeverity_OrderingAcrossEnumValues, TestHealthReportResultSeverity_PassIsLowestNonZero
...
Cohesion: 0.5
Nodes (3): IsAbsent(), TestCountAbsent(), countAbsent()
...
- **Why does `join()` connect `Community 40` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 136`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 26`, `Community 33`, `Community 41`, `Community 61`, `Community 67`, `Community 84`, `Community 88`, `Community 89`, `Community 96`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `NewScheme()` connect `Community 41` to `Community 97`, `Community 5`, `Community 7`, `Community 9`, `Community 106`, `Community 10`, `Community 14`, `Community 17`, `Community 50`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 0` to `Community 10`, `Community 11`, `Community 7`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 50 inferred relationships involving `join()` (e.g. with `normalizeShell()` and `runMain()`) actually correct?**
  _`join()` has 50 INFERRED edges - model-reasoned connections that need verification._
