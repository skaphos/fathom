# Graph Report - fathom  (2026-07-04)

## Corpus Check
- 106 files · ~119,675 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1446 nodes · 2434 edges · 86 communities (72 shown, 14 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 325 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `44cc59a5`
...
7. `Load()` - 18 edges
8. `newFakeClient()` - 18 edges
9. `NewScheme()` - 17 edges
...
Cohesion: 0.06
Nodes (64): flagBinding, MetricsOptions, Options, bindings(), Load(), RegisterFlags(), newTestFlags(), TestDefaultOptions_MatchFlagDefaults() (+56 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (35): Adapter, FamilyOutcome(), TestFamilyOutcome(), TestOutcomeValid(), Capabilities, CheckResult, Family, FamilyPolicy (+27 more)
...
Cohesion: 0.05
Nodes (50): AddonCheckReconciler, AddonCheckReconciler.Reconcile, addonAdapterLookup interface, aggregateHealthReportResult, healthReportForAddonCheck, labels fathom.skaphos.io/source-{kind,name}, AddonCheckReconciler.pruneHealthReportHistory, resolveAddonAdapter (+42 more)
...
Cohesion: 0.21
Nodes (30): adapterWithLauncher(), assertHasDetail(), assertHasOutcome(), dnsEndpointSlice(), dnsEndpointSliceNamed(), dnsService(), dnsServiceNamed(), healthyDeployment() (+22 more)
...
Cohesion: 0.11
Nodes (20): healthReportResult (outcome mapping), coredns.Adapter, coredns.Adapter.Run, adapterOutcome (probe.Outcome mapping), coredns.Adapter.checkDNSResolution, coredns.Adapter.checkSystemHealth, dnsProbeLauncher interface, dnsProbePodName (+12 more)
...
## Knowledge Gaps
- **345 isolated node(s):** `config`, `version`, `Adapter`, `Capabilities`, `Request` (+340 more)
...
- **Why does `join()` connect `Community 1` to `Community 3`, `Community 4`, `Community 7`, `Community 11`, `Community 13`, `Community 17`, `Community 18`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `NewScheme()` connect `Community 3` to `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 17`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 0` to `Community 2`, `Community 10`, `Community 14`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Are the 36 inferred relationships involving `join()` (e.g. with `normalizeShell()` and `runMain()`) actually correct?**
  _`join()` has 36 INFERRED edges - model-reasoned connections that need verification._
