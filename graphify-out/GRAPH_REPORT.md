# Graph Report - rebase-pr-121  (2026-07-05)

## Corpus Check
- 141 files · ~147,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2229 nodes · 3535 edges · 168 communities (148 shown, 20 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 494 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f2c11e5`
...
Cohesion: 0.05
Nodes (44): Adapter, FamilyOutcome(), IsAbsent(), MarkVersionGate(), TestFamilyOutcome(), TestMarkAbsentAndIsAbsent(), TestMarkVersionGate(), TestOutcomeValid() (+36 more)
...
Cohesion: 0.14
Nodes (24): certificateCheck(), certificateDetails(), check(), conditionDetails(), conditionStatus(), conditionType(), daysRemaining(), daysThreshold() (+16 more)
...
Cohesion: 0.1
Nodes (23): Adapter catalog, Add-on Checks, cert-manager, Cilium, code:yaml (apiVersion: fathom.skaphos.io/v1alpha1), code:yaml (spec:), code:yaml (spec:), code:yaml (spec:) (+15 more)
...
Cohesion: 0.12
Nodes (12): Adapter, certManagerComponents(), deploymentAvailable(), endAdapterRunSpan(), familyEnabled(), familyPolicy(), mutatingWebhookClients(), restartWarnCount() (+4 more)
...
Cohesion: 0.27
Nodes (8): TestMustEngine_PanicsOnInvalid(), crdAbsenceEngine(), TestCRD_AbsenceResolution(), endRunSpan(), MustEngine(), NewEngine(), TestNewEngine_Validation(), validWorkloadKind()
...
Cohesion: 0.38
Nodes (8): podInNamespace(), NewExternalDNSEngine(), extdnsHealthyObjects(), TestExternalDNS_AdapterMetadata(), TestExternalDNS_DeploymentNameThresholdOverride(), TestExternalDNS_HealthyPassesAllFamilies(), TestExternalDNS_MissingCRDSkippedOptional(), TestExternalDNS_MissingDeploymentFails()
...
Cohesion: 0.22
Nodes (8): Addon adapter RBAC, cert-manager, cilium, coredns, external-dns, external-secrets, metrics-server, Operator impersonation grant
...
## Knowledge Gaps
- **710 isolated node(s):** `config`, `RBACDeclarer`, `version`, `Adapter`, `Capabilities` (+705 more)
...
- **Why does `join()` connect `Community 40` to `Community 1`, `Community 2`, `Community 4`, `Community 7`, `Community 136`, `Community 17`, `Community 18`, `Community 19`, `Community 25`, `Community 26`, `Community 36`, `Community 41`, `Community 43`, `Community 52`, `Community 69`, `Community 86`, `Community 89`, `Community 97`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `NewScheme()` connect `Community 41` to `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 108`, `Community 14`, `Community 17`, `Community 51`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 0` to `Community 8`, `Community 10`, `Community 6`?**
